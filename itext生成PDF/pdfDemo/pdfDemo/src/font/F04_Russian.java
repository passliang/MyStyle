/********************** 版权声明 *************************
 * 文件名: F04_Russian.java
 * 包名: font
 * 版权:	杭州华量软件  pdfDemo
 * 职责:	
 ********************************************************
 *
 * 创建者：peijd   创建时间：2016年7月6日 下午5:40:03
 * 文件版本：V1.0 
 *
 *******************************************************/
package font;
...
public class F04_Russian {
    public static final String DEST = "results/font/f04_russian_wrong_encoding.pdf";
    public static final String FONT = "resources/fonts/FreeSans.ttf";
 
    public static void main(String[] args) throws IOException, DocumentException {
        File file = new File(DEST);
        file.getParentFile().mkdirs();
        new F04_Russian().createPdf(DEST);
